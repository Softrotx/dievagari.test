	...
	<div id="vamtam-ts-main">
		<div class="main-content">
			<div class="vamtam-sd vamtam-box-wrap">
				<header>
					<h3><?php esc_html_e( 'Support and Documentation', 'mozo' ); ?></h3>
				</header>
				<div class="content">
					<span><?php esc_html_e( 'Thank you for purchasing our theme! Feel free to browse our knowledgebase for videos and extra help.', 'mozo' ); ?></span>
					<div class="cards-wrap">
						<span class="vamtam-box-btn">
							...
							<a href="https://beaver.support.vamtam.com/support/home" class="button" target="_blank">
								<?php esc_html_e( 'Knowledgebase', 'mozo' ); ?>
							</a>
						</span>
						<span class="vamtam-box-btn">
							...
							<a href="https://beaver.support.vamtam.com/support/solutions/articles/227251-vamtam-beaver-themes-how-to-install-the-theme-via-the-admin-panel-" class="button" target="_blank">
								<?php esc_html_e( 'Installation Guide', 'mozo' ); ?>
							</a>
						</span>
						<span class="vamtam-box-btn">
							...
							<a href="https://beaver.support.vamtam.com/support/solutions/articles/227252-vamtam-beaver-themes-how-to-update-a-vamtam-theme-and-the-bundled-plugins-" class="button" target="_blank">
								<?php esc_html_e( 'How to Update Guide', 'mozo' ); ?>
							</a>
						</span>
						<span class="vamtam-box-btn">
							...
							<a href="https://beaver.support.vamtam.com/support/solutions/articles/229569-vamtam-beaver-themes-video-guides-for-beginners" class="button" target="_blank">
								<?php esc_html_e( 'Video Guides for Beginners', 'mozo' ); ?>
							</a>
						</span>
						<span class="vamtam-box-btn">
							...
							<a href="https://vamtam.com/child-themes" class="button" target="_blank">
								<?php esc_html_e( 'Child Themes', 'mozo' ); ?>
							</a>
						</span>
						<span class="vamtam-box-btn">
			...
			<div class="vamtam-hd-ss-wrap">
				<div class="vamtam-hd vamtam-box-wrap">
					<header>
						<h3><?php esc_html_e( 'Have any queries outside of the scope?', 'mozo' ); ?></h3>
					</header>
					<div class="content">
						<p class="vamtam-description"><?php esc_html_e( 'Should you have any queries outside of the scope of the help materials and the video guides don\'t hesitate to contact us.', 'mozo' ); ?></p>
						<a href="https://themeforest.net/user/vamtam" class="vamtam-ts-button button" target="_blank">
							<?php esc_html_e( 'Contact Us', 'mozo' ); ?>
						</a>
					</div>
				</div>
				<div class="vamtam-ss vamtam-box-wrap">
					<header>
						<h3><?php esc_html_e( 'Enable System Status Information Gathering', 'mozo' ); ?></h3>
					</header>
					<div class="content">
						...
						<div id="vamtam-post-result">
							...
							<p style="color: green;" class="vamtam-post-msg-success"><?php echo esc_html__( 'Settings Saved Successfully', 'mozo' ) ?></p>
							<p style="color: red;" class="vamtam-post-msg-failure"><?php echo esc_html__( 'There was a problem saving the settings to the database, please try again.', 'mozo' ) ?></p>
						</div>
					</div>
				</div>
			</div>
