		...
		<?php if ( ( $show_tax || is_customize_preview() ) && !!$tags ) : ?>
			<div class="post-content-meta">
				<div class="the-tags vamtam-meta-tax" <?php VamtamTemplates::display_none( $show_tax ) ?>>
					<?php the_tags( '<span class="visuallyhidden">' . esc_html__( 'Tags', 'mozo' ) . '</span> ', ', ', '' ); ?>
				</div>
			</div>
		<?php endif ?>

		<div class="vamtam-button-wrap vamtam-button-width-auto vamtam-button-left">
			<a href="<?php the_permalink() ?>" target="_self" class="vamtam-button button-underline" role="button">
				<span class="vamtam-button-text"><?php esc_html_e( 'READ MORE', 'mozo' ) ?></span>
			</a>
		</div>
