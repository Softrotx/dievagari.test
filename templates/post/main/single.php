...
?><div class="post-content-outer single-post">
	...
	<?php if ( $meta_author || $meta_date || $meta_comments || is_customize_preview() ) : ?>
		<div class="limit-wrapper single-post-meta-wrapper">
			<div class="meta-top">
				<div class="meta-left <?php if ( $meta_author ) echo 'has-author' ?>">
					<?php
						if ( $meta_author ) {
					...
					<?php if ( $meta_author || $meta_date || $meta_comments || is_customize_preview() ) : ?>
						<div class="meta-left-top with-separator">
							<?php if ( $meta_author || is_customize_preview() ) : ?>
								<span class="author vamtam-meta-author" <?php VamtamTemplates::display_none( $meta_author ) ?>><?php echo esc_html( _x( 'by', 'As in: "by Author Name"', 'mozo' ) ) ?><?php the_author_posts_link()?></span>
							<?php endif ?>
